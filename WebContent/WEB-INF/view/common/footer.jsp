...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<footer>
        ...
        <div class="footer-menu">
            ...
            <a href="mailto:cs@busybees.com" style="margin-left: 15px; margin-right: 15px;">문의하기</a>
            <a href="#" style="margin-left: 15px;">공지하기</a>
        </div>
        <div class="social-media-icon">
            <a href="https://www.facebook.com/"><i class="fab fa-facebook-square fa-2x fb-icon"></i></a>
            <a href="https://www.instagram.com/"><i class="fab fa-instagram-square fa-2x ig-icon"></i></a>
        </div>
    </footer>
